...
public class FightController3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                PlayerPrefs.SetInt("FIGHT_ORDER", 3);
    ...
    public void ShowActions()
    {
        ...
        if (playerScript.energy > 4)
        {
            ...
            if (sorrows.terror > 0 && griefCooldown == false) buttonTerror.interactable = true;
    ...
    IEnumerator ThrowLightStrike(GameObject particleHolder, ParticleSystem particleSystem, ParticleSystem chargeSystem, ParticleSystem floorCharger, int damage)
    {
        ...
        Vector3 chargerInitPos = new Vector3(-10.277f, 1.411f, -0.408f);
        Vector3 finalPos = new Vector3(-7.02f, 1.71f, -0.23f);
        Vector3 floorChargerPos = new Vector3(-11.72f, 0.2f, -0.464f);
